...
module.exports = {
    ...
    bot: {
        ...
        guildID: "1113061225497116712", //Your Discord server guild ID
    },

    //Your Minecraft server data
    server: {
        name: "mchype", //Your server name
        type: "java", //"java" or "bedrock"
        ip: "mchype.pl", //IP of your server - do not include port - e.g. "mc.hypixel.net"
        port: "25565", //PORT of your server - empty => default port (JA 25565, BE 19132)
        icon: "", //Link to icon - like "https://website.com/icon.png"
        version: "1.19.4", //Minecraft version of sever
    ...
    countingCH: {
        channelID: "1113065573941788722",
        time: "1min", //Period of updating channel name - like "3min", "20s" or "1min" etc.
        name: "{onlinePlayers}・online", //Name of the channel
        offline: "Serwer・OFF" //Name of the channel if the server is offline / not found
    },

    //Embeds settings
    embeds: {
        colors: {
            normal: "#FB9427",  //Main/successful color of embeds - choose HEX color here: https://htmlcolorcodes.com
